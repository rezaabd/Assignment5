...
import javax.swing.JTextField;
	public class Assing6 implements ActionListener{
...
// creating the only button on the panel
button = new JButton();
button.setBackground(Color.LIGHT_GRAY);
button.setText("CALCULATE");
button.addActionListener(this);
button.setForeground(Color.BLACK);
// adding to the frame the panel and its components
...
// when this method is invoked, all these actions are performed
